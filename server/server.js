...
const bookRoutes = require("./routes/student-routes/book-routes");
const bookIssueRoutes = require("./routes/student-routes/book-issue-routes");
...
app.use("/student/books", bookRoutes);
app.use("/student/book-issue", bookIssueRoutes);
